...
def rnn_cell_forward(xt, a_prev, parameters):
    ...
    Wax = parameters["Wax"]
#     print(f"Wax: {Wax}")
#     print(f"len Wax: {len(Wax)}")
    print(f"Wax.shape: {Wax.shape}")
    Waa = parameters["Waa"]
#     print(f"Waa: {Waa}")
#     print(f"len Waa: {len(Waa)}")
    print(f"Waa.shape: {Waa.shape}")
    Wya = parameters["Wya"]
#     print(f"Wya: {Wya}")
#     print(f"len Wya: {len(Wya)}")
    print(f"Wya.shape: {Wya.shape}")
    ba = parameters["ba"]
#     print(f"ba: {ba}")
